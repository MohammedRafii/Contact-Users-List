    ...
    <div className='flex bg-black/15 justify-center items-center h-screen w-full'>
      <section className='mb-[2rem] shadow-xl xl:w-[35%] lg:w-[45%] w-[80%] xl:h-auto h-[60%]  rounded-lg bg-blue-400/45 text-center'>
        ...
        <form onSubmit={submitHandler} className='flex flex-col justify-evenly h-[45vh]  xl:h-[75vh]'>
          ...
          <button type="submit" disabled={loading} className='bg-blue-700/45 mx-auto px-10 font-semibold text-xl w-[45%] py-3 rounded-xl text-white hover:scale-105 duration-200'>Login</button>
          ...
          <Link to={"/register"} className='border-x rounded-full border-black mx-auto px-10 font-medium py-3 w-[45%] h-[10px] flex items-center justify-center hover:scale-105 duration-200'>Sign Up</Link>
        </form>
      </section>
    </div>
  )
